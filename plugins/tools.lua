...
local text = matches[2]
tdcli.createNewChannelChat(text, 1, '@monsterTGteam', (function(b, d) tdcli.addChatMember(d.id_, msg.from.id, 0, dl_cb, nil) end), nil)
   if not lang then 
...
if ((matches[1] == 'monster' and not Clang) or (matches[1] == "مانستر" and Clang)) then
...
text = [[
_راهنمای ادمین و سودی ربات مانستر تی جی:_
